...
export function EventsPage() {
  ...
  useEffect(() => {
    ...
    const res = await api.get(`/events?sort_by=${sortBy}&&type=${selectedType}`);
    setEvents(res.data);
    }
    get_events();
  },[sortBy, selectedType]);
      ...
      <div className="flex gap-8">
        ...
        <aside className="w-64 shrink-0">
          <div className="sticky top-24 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
            ...
            {/* Event Type */}
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Event Type</h3>
            ...
            <div className="mb-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Free Events Only</span>
              </label>
            </div>            
          </div>
        </aside>
