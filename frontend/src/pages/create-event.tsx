...
export function CreateEventPage() {
  ...
  const checkVenueAvailability = () => {
    ...
    const hasConflict = conflictingVenues.includes(formData.venue) && 
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-8">
        ...
        {step === 1 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Event Basics</h2>
            ...
            <div>
              ...
              <div className="flex gap-4">
                {(['physical', 'online', 'hybrid'] as EventType[]).map((type) => (
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-700 dark:text-gray-300 font-medium mb-1">
                  Drop your banner here, or <label htmlFor="banner-upload" className="text-blue-600 dark:text-blue-400 cursor-pointer hover:underline">browse</label>
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">Recommended: 1200x675px</p>
        ...
        {step === 2 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Event Logistics</h2>
              ...
              {venueConflict && (
                <div className="mt-2 flex items-start gap-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                  ...
                  <p className="text-sm text-red-800 dark:text-red-200">
                    Venue conflict detected! Please choose a different date or venue.
                  </p>
                </div>
              )}
            </div>
        ...
        {step === 3 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Ticketing</h2>
            ...
            <div>
              <label className="flex items-center gap-2 cursor-pointer mb-4">
                ...
                />
                <span className="text-sm font-medium text-gray-900 dark:text-white">Free Event</span>
              </label>
        ...
        {step === 4 && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-4">
              <div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Event Title</div>
                <div className="text-lg font-medium text-gray-900 dark:text-white">{formData.title}</div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Type</div>
                  <div className="font-medium text-gray-900 dark:text-white capitalize">{formData.type}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Venue</div>
                  <div className="font-medium text-gray-900 dark:text-white">{formData.venue}</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Date & Time</div>
                  <div className="font-medium text-gray-900 dark:text-white">{formData.date} at {formData.time}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Capacity</div>
                  <div className="font-medium text-gray-900 dark:text-white">{formData.totalSeats} seats</div>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-gray-900 dark:text-white whitespace-pre-line">{formData.description}</div>
              </div>
            </div>
          </div>
        )}
