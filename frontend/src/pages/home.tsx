...
export function HomePage() {
  ...
  const [event_loading, setEventLoading] = useState<boolean>(true);
  const [club_loading, setClubLoading] = useState<boolean>(true);
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="max-w-screen-2xl mx-auto px-6 text-center text-white">
            ...
            <p className="text-xl mb-10 max-w-2xl mx-auto drop-shadow-md">
              Connect with clubs, attend exciting events, and make the most of
