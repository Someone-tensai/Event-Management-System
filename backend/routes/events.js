...
events_router.post("/create", is_logged_in, upload.fields([
    {name:'banner', maxCount: 1}
]),is_eligible_to_create, create_new_event);
events_router.put("/:event_id", is_logged_in, upload.fields([
    {name:'banner', maxCount: 1}
]), is_eligible_to_create, edit_event);
