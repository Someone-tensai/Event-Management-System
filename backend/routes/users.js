...
const {update_user_info, register_user_data, login_user, get_all_users, logout_user, send_user_data} = require("../controllers/user_controller");
...
user_router.post("/update", is_logged_in, update_user_info);
